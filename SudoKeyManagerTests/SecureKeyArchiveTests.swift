...
class SecureKeyArchiveTests: XCTestCase {
    ...
    func testKeyArchiveFromAndroidInterop() {
        ...
        do {
            let gunzipped = try Data(base64Encoded: exportedKeys)!.gunzipped()
            print(gunzipped.base64EncodedString())
            let tempKeyManager: SudoKeyManager = LegacySudoKeyManager(serviceName: "com.sudoplatform.appservicename", keyTag: "com.sudoplatform", namespace: "email-integration-tests")
            ...
            XCTAssertEqual("", privateKey.base64EncodedString())

            let encryptedRfc822Headers = "".data(using: .utf8)

            // Only testing this on iOS >=17 as key format is incompatible for earlier versions
            if (ProcessInfo.processInfo.operatingSystemVersion.majorVersion > 16) {
                let decryptedHeaders = try tempKeyManager.decryptWithPrivateKey("19c035bd-60f9-499c-98ec-f9d195d926e4", data: (encryptedRfc822Headers?.subdata(in: Range(uncheckedBounds: (0, 256))))!)
                XCTAssertNotNil(decryptedHeaders)
            } else {
                print("Skipping private key decrypt test. iOS version: \(ProcessInfo.processInfo.operatingSystemVersion.majorVersion)")
            }

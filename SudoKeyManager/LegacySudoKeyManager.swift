...
/// cryptography uses AES-CBC with 256 bit key and public key cryptography uses
/// RSA with OAEP padding, SHA1 digest and 4096 bit key. This is now deprecated
/// and only used for backward compatibility with existing encrypted data.
final public class LegacySudoKeyManager {
    ...
    /// Intializes a new `LegacySudoKeyManager` instance with the specified service name, namespace and key sizes.
    ///
    /// - Parameters:
